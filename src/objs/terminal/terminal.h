...
namespace terminal {
	...
	class terminal_interface {
		public:
			virtual unsigned tests_begun (void) = 0;
			virtual unsigned test_suite_block_begun (const std::string& test_suite_description) = 0;
			virtual unsigned test_case_discovered (const std::string& test_case_description) = 0;
			virtual unsigned test_suite_block_ended (void) = 0;
			...
			virtual void tests_ended (void) = 0;
	};
